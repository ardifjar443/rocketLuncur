...
<body>
    <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <ul class="space-y-4">
            ...
            <li class="bg-gray-700 p-4 rounded-lg shadow-md flex gap-4">
                ...
                <div>
                    ...
                    <p class="text-blue-400 font-semibold">🚀 {{ $launch['rocket']['configuration']['full_name'] ??
                        'Unknown
                        Rocket' }}</p>
        ...
        <a href="{{ route('dashboard') }}"
            class="block mt-6 text-center bg-gray-700 text-white py-2 rounded-lg hover:bg-gray-600">
